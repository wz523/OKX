...
def apply_tuning(cfg: Dict[str, Any], mkt, acc, grid, guard):
    ...
    global TREND_USE_TARGET, TREND_TARGET_USD_LONG, TREND_TARGET_USD_SHORT, TREND_MULTIPLIER_LONG, TREND_MULTIPLIER_SHORT
    global TREND_COOLDOWN_SEC, TREND_DAILY_CAP, TREND_MAX_NOTIONAL_USD, TREND_MIN_DISTANCE_PCT
    global GRID_STEP_USD, GRID_LEVELS_PER_SIDE, RECENTER_PCT, POST_ONLY
